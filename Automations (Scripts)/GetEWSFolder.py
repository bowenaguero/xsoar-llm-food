...
def main():
    ...
    folders_paths_list = [folder.strip()
                          for folder in folders_paths_str.split(",")]
    path_to_mails = {folder: []
                     for folder in folders_paths_list}  # type: Dict[str, List[str]]
    ...
    mails_from_all_folders_list = [
        mail_json for folder_mails in path_to_mails.values() for mail_json in folder_mails]
